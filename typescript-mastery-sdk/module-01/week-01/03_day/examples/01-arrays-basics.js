...
console.log("\n=== SDK Example ===");
let recipients = ["+923001234567", "+923001234568", "invalid"];
// Filter valid phone numbers
let validRecipients = recipients.filter(phone => phone.startsWith('+') && phone.length >= 10);
console.log("Valid recipients:", validRecipients);
console.log("Total valid:", validRecipients.length);
let messages = validRecipients.map(phone => ({
    to: phone,
    text: "Hello from SDK"
}));
