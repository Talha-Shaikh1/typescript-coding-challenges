...
let wabaIds = ["1213", "wamid_1231", "4567", "wamid_4567"];
let validIds = wabaIds.filter(id => id.startsWith("wamid_")).map(id => ({
    id: id,
    verified: true
}));
...
let cities = ["Karachi", "Lahore", "Delhi", "Hyderabad"];
