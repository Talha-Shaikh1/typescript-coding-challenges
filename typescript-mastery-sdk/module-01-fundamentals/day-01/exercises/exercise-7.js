...
let isPhoneStartWithPlus = phone.startsWith("+");
// TODO: Get phone length → phoneLength (number)
let phoneNumberLenght = phone.length;
// TODO: Check if length >= 10 → hasValidLength (boolean)
let hasValidLength = phoneNumberLenght >= 10;
// TODO: Both checks must pass → isValid (boolean)
let isValid = isPhoneStartWithPlus && hasValidLength;
